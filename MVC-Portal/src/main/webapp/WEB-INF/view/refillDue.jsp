...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <!-- Icon -->
    <!-- Login Form -->
    <form action="/refillDueView">
  <div class="form-group">
    <label for="MemberId">Subscription Id</label>
    <input type="number" class="form-control" id="subscriptionId"name="subscriptionId" aria-describedby="subscriptionId">
  ...
  <button type="submit" class="btn btn-primary" id="btn">Get Details</button>
</form>
