...
<body>
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="navbar-item"><div class="dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							<a class="dropdown-item" href="subscriptionIdsOfMember">Details</a>
	...
	<div class="container my-5">
		...
		<div class="wrapper fadeInDown">
			<div id="formContent">
				<form action="addDrugs" method="GET">
					<div class="form-group">
						Total drug Count <input class="form-control" type="text"
							name="count">
					</div>
					<div>
						<input class="form-control btn btn-primary" id="btn" type="submit"
							value="Submit">
					</div>
				</form>
			</div>
