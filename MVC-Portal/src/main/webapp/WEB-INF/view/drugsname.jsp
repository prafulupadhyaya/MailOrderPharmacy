...
<body>
	...
	<div class="container mt-5">
		<h2>Drug Details</h2>
				<form action="drugviewname?name=${drugs.name}" >
					<div class="form-group">
						<label for="name">Drug name</label>
						<input type="text"
							class="form-control" id="name" name="name" aria-describedby="drugName">
					</div>
					<button type="submit" class="btn btn-primary" id="btn">Get
						Details</button>
						<button type="button" onclick="window.location.href = 'drugs';"class="btn btn-primary" id="btn2">Search By Id</button>
