...
<div class=container>
	<div id="formContent">
<form:form method="POST" action="adhoc" modelAttribute="drugs">
<div class="form-group">
<label>Subscription Id</label>
<input type="number"  class="form-control"name="subscriptionId" value="${subId}"readonly="true"/></div>
<div class="form-group">
<label>Policy Id</label>
<input type="number"  class="form-control"name="policyId"/></div>
<div class="form-group">
<label>Location</label>
<input type="text"  class="form-control"name="location"/></div>
<table>
<tr>
<th>Drug Name</th>
<th>Drug Quantity</th>
...
<c:forEach items="${drugs.allDrugsList}" var="drug"
							varStatus="tagStatus">
							<tr>
								<td><div class="form-group"><form:input class="form-control"
										path="allDrugsList[${tagStatus.index}].drugName"
										value="${drug.drugName}" readonly="false" /></div></td>
								<td><div class="form-group"><form:input class="form-control"
										path="allDrugsList[${tagStatus.index}].quantity"
										value="${drug.quantity}" readonly="false" /></div></td>
