...
<body>
	...
	<div class="container mt-5">
		<h2>Drug Details</h2>
				<form action="drugview?id=${drugs.id}" >
					<div class="form-group">
						<label for="id">Drug Id</label>
						<input type="number"
							class="form-control" id="id" name="id" aria-describedby="drugId">
					</div>
					<button type="submit" class="btn btn-primary" id="btn">Get
						Details</button>
						<button type="button" onclick="window.location.href = 'drugsname';"class="btn btn-primary" id="btn2">Search By Name</button>
				</form>
