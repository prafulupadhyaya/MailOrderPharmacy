...
<body>
	...
	<nav class="navbar navbar-expand-md navbar-dark">
		<a class="navbar-brand" href="/landing"><i class="material-icons">add_location_alt</i>
	...
	<div class="container mt-5 pt-5">
		<div class="row">
			<div class="col-12 col-sm-8">
				...
				<h2 class="landing">UNAUTHORISED TO USE THIS PAGE. PLEASE LOGIN OR SIGNUP.</h2>
				<button type="button" class="btn btn-primary mt-3 mr-2"
					onclick="window.location.href = 'login';" id="btn">Login</button>
				<button type="button" class="btn btn-primary mt-3"
					onclick="window.location.href = 'signup';" id="btn2">Signup</button>
			</div>
