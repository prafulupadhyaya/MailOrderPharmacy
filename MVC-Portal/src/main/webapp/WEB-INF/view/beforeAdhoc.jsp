...
<body>
	...
	<div class="container my-5">
		<h2>Enter Subscription Id</h2>

		<div class="wrapper fadeInDown">
			<div id="formContent">
				<form action="addDrugsToAdhoc" method="POST">
				Subscription Id
					<div class="form-group">
					
            <input type="text"class="form-control" name="subscriptionId"></div>
            <div class="form-group"><input type="submit"class="form-control"class="btn btn-primary mt-2" id="btn" value="Submit">
            </div>
            </form>
        </div>
