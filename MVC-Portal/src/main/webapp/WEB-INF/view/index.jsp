				...
				<li class="navbar-item"><div class="dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							<a class="dropdown-item" href="subscriptionIdsOfMember">Details</a> <a
								class="dropdown-item" href="/landing">Logout</a>
						</div>
					</div></li>
			</ul>
		</div>
	...
	<div class="container mt-5 pt-5">
		<div class="row">
			<div class="col-12 col-sm-8">
				...
				<h2 class="landing">TO</h2>
				<h2 class="landing">MAIL ORDER PHARMACY</h2>
				<button type="button" class="btn btn-primary mt-3 mr-2"
					onclick="window.location.href = 'subscribe';" id="btn">Subscribe</button>
				<button type="button" class="btn btn-primary mt-3"
					onclick="window.location.href = 'drugs';" id="btn2">Drug
					Details</button>
			</div>
