...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form:form action="/login" method="post" modelAttribute="login" class="mt-3">
        ...
        <input type="submit" value="Login"id="btn" class="btn btn-success mr-2"/>
        <input type="reset" value="Reset" id="btn2"class="btn btn-danger"/>
    </form:form>
